# Gulp - сборка SlinkySlinky на основе сборки MaxGraph

*Структура файлов изменена согласно методологии BEM. Файлы группируются по блокам, а не по расширению. Отдельному блоку соответсвует отдельная папка с html, scss и js (опционально) файлами. 
Уникальные для страницы/экрана блоки следует располагать внутри соответсвующих папок. Общие для всех страниц/экранов компоненты - в папке components.
!!!! При удалении или добавлении страниц необходимо внести изменение в массив pages в файле gulpfile.js

** Большая часть документации и готовых решений принадлежит MaxGraph. Постепенно будет дополняться и перерабатываться
...
│   │   ├── _elements                # папка с общими для всех страниц html элементами
│   │   ├── _scripts                 # папка с общими для всех страниц скриптами
│   │   │   ├── functions            # папка с функциями
│   │   │   └── common.js            # файл с общими для всех страниц скриптами
│   │   ├── _styles                  # папка с общими для всех страниц стилями
│   │   │   ├── mixins               # папка с миксинами
│   │   │   ├── common.scss          # файл с общими для всех страниц стилями
│   │   │   ├── container.scss       # файл настроек контейнеров
│   │   │   └── fonts.scss           # файл настройки шрифтов
│   │   ├── header                   # папка компонента header с вложенными папками и файлами по BEM
│   │   │   ├── header.html
│   │   │   ├── header.js
│   │   │   └── header.scss
│   │   └── footer                   # папка компонента footer
│   ├── img                          # папка для изображений
│   │   ├── svg                      # специальная папка для преобразования svg в спрайт
│   │   └── cover.jpg                # картинка
│   ├── pages                        # папка для страницы по системы BEM
│   │   ├── about                    # папка страницы about
│   │   └── index                    # папка главной страницы
│   │       ├── screens              # папка с экранами страницы
│   │       │   └── home             # папка экрана с вложенными блоками и файлами экрана
│   │       │       ├── home.html    
│   │       │       ├── home.js       
│   │       │       └── home.scss         
│   │       ├── index.html           # главный html файл страницы 
│   │       ├── index.js             # главный js файл страницы
│   │       └── index.scss           # главный scss файл страницы
│   ├── resources                    # папка для хранения иных ассетов - php, видео-файлы, шрифты и пр.
│   │   ├── fonts                    # папка для хранения шрифтов в формате woff2
│   │   ├── phpmailer                # папка для рассылки писем
│   │   ├── favicon.ico              # фавиконка
│   │   └── mail.php                 # скрипт для расслыки писем
│   ├── templates                    # папка для хранения готовых блоков, элементов, миксинов и функций
│   ├── variables                    # папка для переменных
│   └── vendors                      # папка для сторонних библиотек
